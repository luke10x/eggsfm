...
em++ -std=c++17 -O2 \
    ...
    ../../my-ym2612-plugin/build/_deps/ymfm-src/src/ymfm_opm.cpp \
    ../../my-ym2612-plugin/build/_deps/ymfm-src/src/ymfm_opl.cpp \
    ...
    -s ASYNCIFY \
    -s ASSERTIONS \
    --shell-file ../demo/shell.html \
    -o www/index.html

(cd www && python3 -mhttp.server)
